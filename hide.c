...
char** initiater(char **a,int ***ans)
{
    ...
    *ans=(int**)malloc(10*sizeof(int*));
    ...
    strcpy(a[0],"WWWMILAZSD");
    strcpy(a[1],"DYTRYGWSOH");
    strcpy(a[2],"PRWAJBQOOO");
    strcpy(a[3],"BZAFRMEBKE");
    strcpy(a[4],"RVGZKAFTYI");
    strcpy(a[5],"MNOOILUOBO");
    strcpy(a[6],"XODQNLVWTW");
    strcpy(a[7],"LIOGORFOLC");
    strcpy(a[8],"HJLSVZRRXD");
    strcpy(a[9],"VJKOEWUGEF");
    return a;
}
